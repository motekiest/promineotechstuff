...
//			values[5] = 6;
			...
			// System.out.println(values[6]); ++ outOfBoundsException
				
				// 5. Print out the element in the array at position -1, what happens?
			// System.out.println(values[-]); ++ outOfBoundsException
		...
		String[] names = {"Sam", "Saally", "Thomas", "Robaet"};
...
//		System.out.println(doesArrayContainString(names, "Hi"));	
...
//		System.out.println(hasMoreEvenWordCharacters(names));
	...
	System.out.println(isPalindrome("racecar"));
			...
			// Method 13:Write and test a method that takes a String name and prints out a greeting. This method returns nothing.
				public static void greet(String name) {
					System.out.println("Hello, " + name + "!");
						}

			// Method 14: Write and test a method that takes a String name and returns a greeting.  Do not print in the method.
			...
			// Method  15: Write and test a method that takes a String and an int and returns true if the number of letters in the string is greater than the int
				public static boolean isStringLongerThanNumber (String string, int number)	{
					return (string.length()> number);
						}
			
			// Method 16: Write and test a method that takes an array of string and a string and returns true if the string passed in exists in the array
...
public static int rectanglePerimeter(int[] args){
    int length =4;
    int width = 4;
    int sum = 0;
int perimeter = sum + length + length + width+width; {
return perimeter;
